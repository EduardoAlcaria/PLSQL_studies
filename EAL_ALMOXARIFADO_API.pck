...
create or replace package body EAL_ALMOXARIFADO_API is
   ...
   begin
      if almox.codigAlmox is not null and almox.cod_emp_id is not null
        and almox.descAlmox is not null then
   ...
   is
      ret varchar2(255);
   begin
      select Eal_Almoxarifado_Tab.Cod_Emp_Id into ret from EAL_ALMOXARIFADO_TAB
      where codigAlmox =  EAL_ALMOXARIFADO_TAB.codigAlmox;
      return ret;
   end get_emp___;
   ...
   is
      ret varchar2(255);
   begin
      select Eal_Almoxarifado_Tab.Descalmox into ret from EAL_ALMOXARIFADO_TAB
      where codigAlmox =  EAL_ALMOXARIFADO_TAB.codigAlmox;
      return ret;
   end get_desc___;
